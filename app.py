          ...
          <div class="ch-logo-row">
            <div class="ch-logo-icon">
              <svg viewBox="0 0 100 100" width="44" height="44" xmlns="http://www.w3.org/2000/svg">
                <path d="M 5 97 L 27 27 A 37 37 0 1 0 97 27 L 97 52 Z" fill="#F5C500"/>
                <path d="M 5 97 A 51 51 0 0 1 97 52 Z" fill="#F07820"/>
                <path d="M 30 72 A 35 35 0 0 1 97 52 Z" fill="#2196C4"/>
              </svg>
            </div>
            <div>
